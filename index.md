...
<section class="homepage__key_points card">
    ...
    <a target="_blank" onclick="_track('juejin-homepage')" href="https://doc.flutterdart.cn" style="width: 160px; border: #009bea 1px solid;background-color: white; color: #0074bb;text-transform:none; padding:15px" class="get-started-button">Flutter中文社区</a>
    </div>
